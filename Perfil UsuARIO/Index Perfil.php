  ...
  <header class="bg-white shadow-lg sticky top-0 z-50">
    <div class="container mx-auto flex justify-between items-center p-6 max-w-7xl">
      ...
      <nav class="hidden md:flex space-x-8 font-semibold text-turquesa tracking-wide">
        <a href="index.html" class="hover:text-amarillo-oscuro transition">Inicio</a>
        <a href="index.html#clubes" class="hover:text-amarillo-oscuro transition">Clubes</a>
      ...
      <div class="flex items-center space-x-4">
        <div id="userMenu" class="relative">
          <button class="flex items-center space-x-2">
            ...
            <span class="font-semibold text-turquesa">Sabrina</span>
          </button>
    ...
    <section class="bg-white rounded-3xl shadow-lg p-8 mb-12">
      <div class="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
        ...
        <div class="flex-grow text-center md:text-left">
          <h1 class="text-4xl font-extrabold text-turquesa mb-2">Sabrina Grisel</h1>
